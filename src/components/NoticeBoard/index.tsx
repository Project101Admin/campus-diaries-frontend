...
const Title = () => (
  <a href="/">
    <img className=" h-20 inline w-18" src="https://en.janbharattimes.com/wp-content/uploads/2022/01/campus-diaries.jpg" alt="This is logo" />
  </a>
);
